...
const  englishLinks = {
    ...
    1: 'https://erpprodapp.nbe.ahly.bank:443/OA_HTML/RF.jsp?function_id=22702&resp_id=-1&resp_appl_id=-1&security_group_id=0&lang_code=US&oas=q-Srf3Agyj0FK3lq_kISgw..&params=zRFQRbBycZ.qJn6MjdsvTHwrCqmoqEZgoNIo2AHnmhFOpz74Zp-8WibSthQ280tD2l.2fb8swesWQ.WTNl38nw'
}
    ...
    return (
        <div className="englishLearningRoller">
            <div className='englishLearningRoller__textContainer' > 
                ...
                {/** right arrow */}
                {englishLearnIndex < 1 && <img src={rightArrow} alt="rightArrow" className='englishLearningRoller__textContainer--rightArrow' onClick={increaseEnglishLearnIndex} />}
